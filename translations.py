...
I18N = {
    "pt": {
        ...
        "faq_q1": "Preciso saber programar em Python?",
        "faq_a1": "Não. Essa é a nossa missão. A OpenCanvas Pro elimina a barreira do código. Você traz o conhecimento do seu negócio e os dados; a E.M.I.L.I.A. cuida de toda a programação, limpeza e treinamento dos modelos matemáticos.",
        "faq_q2": "Meus dados estão seguros?",
        "faq_a2": "Sim. Na versão Community, utilizamos processamento em memória volátil. Isso significa que seus dados são usados apenas durante a sessão ativa e são automaticamente deletados dos nossos servidores assim que você fecha a página.",
        "faq_q3": "É realmente gratuito?",
        "faq_a3": "Sim. O Community Studio é nossa contribuição para democratizar a Ciência de Dados. Você tem acesso a todos os recursos essenciais sem pegadinhas e sem precisar cadastrar cartão de crédito.",
        ...
        "faq_q6": "Quando a versão Journey será lançada?",
        "faq_a6": "Estamos em fase final de testes de infraestrutura para garantir estabilidade com grandes volumes de dados. Clique em 'Falar com Contato' na tabela acima para entrar na lista de espera prioritária.",
        "faq_q7": "Posso confiar nos resultados matemáticos?",
        "faq_a7": "Absolutamente. Não reinventamos a roda, apenas a motorizamos. O motor do OpenCanvas Pro roda sobre as bibliotecas mais robustas do mundo: PyCaret, Pandas, NumPy e Scikit-Learn. É a mesma stack tecnológica utilizada por grandes empresas de tecnologia, garantindo precisão estatística e científica.",
        "faq_q8": "Quem é a E.M.I.L.I.A. e como ela me ajuda?",
        "faq_a8": "E.M.I.L.I.A. (Engenharia de Machine Learning e Inteligência Artificial) é o cérebro da nossa plataforma. Ela atua como sua 'Cientista de Dados Sênior' dedicada: ela não apenas responde perguntas, mas analisa ativamente seus dados, sugere os melhores caminhos estatísticos e traduz gráficos complexos para uma linguagem de negócios clara.",
        "faq_q9": "Se é gratuito, como o projeto se sustenta?",
        "faq_a9": "Acreditamos no Open Source sustentável. A versão Community é mantida através de doações da comunidade (patronos) e, futuramente, pelas assinaturas do plano Journey. Nosso objetivo não é vender seus dados, mas sim criar uma ferramenta que nós mesmos gostaríamos de usar.",
    ...
    "en": {
        ...
        "faq_q1": "Do I need to know how to program in Python?",
    ...
    "es": {
        ...
        "faq_q1": "¿Necesito saber programar en Python?",
    ...
    "fr": {
        ...
        "faq_q1": "Dois-je savoir programmer en Python ?",
    ...
    "de": {
        ...
        "faq_q1": "Muss ich Python programmieren können?",
    ...
    "hi": {
        ...
        "faq_q1": "क्या मुझे पायथन में प्रोग्राम करना आना चाहिए?",
